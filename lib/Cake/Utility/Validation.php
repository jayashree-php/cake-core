 ...
 */
		...
		if ($regex === null) {
			switch ($country) {
				...
				/*	$regex = '/^(?:(?:\+?1\s*(?:[.-]\s*)?)?';
					...
					$regex .= '([0-9]1[02-9]|[2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)';
					...
					$regex .= '?([0-9]{4})';
					*/
				//	$regex ='/(^[0-9]{3}(-|\s)[0-9]{4}(-|\s)[0-9]{4}$)|(^[0-9]{3}(-|\s)[0-9]{8}$)|(^[0,91,+91][0-9]{10})/';
					$regex ='/(^[0-9]{3}(-|\s)[0-9]{4}(-|\s)[0-9]{4}$)|(^[0-9]{3}(-|\s)[0-9]{8}$)|(^[0-9]{5}(-|\s)[0-9]{6}$)|(^[0-9]{5}(-|\s)[0-9]{3}(-|\s)[0-9]{3}$)|(^[0-9]{11}$)|(^0+\d{10})|(^91+\d{10})|(^(\+91)+\d{10})|(^[987]+\d{9})/';
	...
	public static function mobile($check, $regex = null, $country = 'all') {
		if (is_array($check)) {
			extract(self::_defaults($check));
		}
		...
		if ($regex === null) {
			switch ($country) {
				...
				//Indian mobile numbers
					$regex ='/(^0+\d{10})|(^91+\d{10})|(^(\+91)+\d{10})|(^[987]+\d{9})/';
				break;
			}
		}
		if (empty($regex)) {
